...
@Component({
    ...
    <div class="max-w-6xl mx-auto animate-fade-in-up">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <!-- Distortion Hunter -->
        <div class="group bg-white rounded-3xl p-8 shadow-sm border border-gray-100 relative overflow-hidden opacity-80 decoration-clone grayscale-[0.3] hover:grayscale-0 transition-all">
           <div class="absolute top-4 right-4 bg-gray-100 text-gray-500 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider shadow-sm">Coming Soon</div>
           <div class="w-16 h-16 bg-purple-100 text-purple-500 rounded-2xl flex items-center justify-center mb-6 text-3xl">
              🔍
           </div>
           <h3 class="text-xl font-bold text-gray-800 mb-3">Distortion Hunter</h3>
           <p class="text-gray-500 leading-relaxed">Identify and challenge cognitive distortions in this interactive CBT mini-game.</p>
        </div>

        <!-- Serenity Tower -->
        <div class="group bg-white rounded-3xl p-8 shadow-sm border border-gray-100 relative overflow-hidden opacity-80 hover:opacity-100 transition-all">
           <div class="absolute top-4 right-4 bg-gray-100 text-gray-500 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider shadow-sm">Coming Soon</div>
           <div class="w-16 h-16 bg-green-100 text-green-500 rounded-2xl flex items-center justify-center mb-6 text-3xl">
              🏰
           </div>
           <h3 class="text-xl font-bold text-gray-800 mb-3">Serenity Tower</h3>
